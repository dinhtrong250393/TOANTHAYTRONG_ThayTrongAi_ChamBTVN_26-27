...
const btnTarget = `<button 
              ...
              className="px-5 py-2.5 bg-indigo-50 hover:bg-indigo-100 text-indigo-700 rounded-xl font-bold text-sm transition-all shadow-sm border border-indigo-200 flex items-center justify-center"
            >
...
const btnReplacement = `<button 
              ...
              className="px-5 py-2.5 bg-green-50 hover:bg-green-100 text-green-700 rounded-xl font-bold text-sm transition-all shadow-sm border border-green-200 flex items-center justify-center"
            ...
            <button 
              ...
              className="px-5 py-2.5 bg-orange-50 hover:bg-orange-100 text-orange-700 rounded-xl font-bold text-sm transition-all shadow-sm border border-orange-200 flex items-center justify-center"
