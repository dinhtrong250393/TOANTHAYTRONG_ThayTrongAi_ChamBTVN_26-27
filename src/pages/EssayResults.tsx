...
export default function EssayResults() {
  ...
  const runBackgroundGrading = async (ungradedSubs: any[], essayData: any, essayIdStr: string, batchGradingIds: string[]) => {
  ...
  if (error || !essay) {
    return (
      <div className="min-h-screen bg-slate-50 p-8 flex flex-col items-center justify-center">
        ...
        <button onClick={() => navigate(-1)} className="px-6 py-2 bg-indigo-600 text-white rounded-xl font-semibold">
          Quay lại
        </button>
      </div>
    );
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            <div className="flex items-center">
              <button onClick={() => navigate(-1)} className="p-2.5 -ml-2.5 mr-3 md:mr-4 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded-full transition-colors">
